...
SELECT TO_DATE('10-11-2024','dd-mm-yyyy') + INTERVAL '10' day AS date_added
FROM DUAL;
...
SELECT TO_CHAR(TO_DATE('2024-11-02', 'YYYY-MM-DD'), 'DAY') AS day_format
FROM DUAL; 
...
SELECT TO_CHAR(TO_DATE('2024-12-30', 'YYYY-MM-DD'), 'DDD') AS day_of_year
FROM DUAL;
...
SELECT TO_CHAR(TO_DATE('2024-11-04', 'YYYY-MM-DD'), 'DD') AS week_of_year
FROM DUAL;
